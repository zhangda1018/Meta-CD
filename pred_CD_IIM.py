...
# DATA_NAME = 'WHU_CD'
from datasets import S2Looking_5 as Data
DATA_NAME = 'S2Looking_15'
################## Load Model and Data ##################
...
class PredOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--chkpt_path', required=False, default=r'/data01/wangfeiyu/open-cd/samcd/checkpoints/S2Looking_CD_100_SAMCD/SAM_CD_e18_OA99.13_F52.07_IoU39.84.pth') 
